...
exports.ALL_PRESETS = exports.DEMO_PRESET_ECONOMIC_WALL = exports.DEMO_PRESET_MEMORY_WALL = exports.DEMO_PRESET_IMAGING_WALL = exports.PRESET_CUSTOM = exports.PRESET_HUMAN_SCALE = exports.PRESET_MOUSE_CIRCUIT = exports.PRESET_DROSOPHILA = exports.PRESET_SMALL_NEURAL_SYSTEM = void 0;
exports.getPresetById = getPresetById;
exports.applyImaging100xDemo = applyImaging100xDemo;
exports.PRESET_SMALL_NEURAL_SYSTEM = {
 ...
 */
exports.DEMO_PRESET_IMAGING_WALL = {
 ...
 */
exports.DEMO_PRESET_MEMORY_WALL = {
    id: 'demo-memory-wall',
 ...
 */
exports.DEMO_PRESET_ECONOMIC_WALL = {
...
function getPresetById(id) {
    const found = exports.ALL_PRESETS.find((p) => p.id === id);
    if (found) {
        return JSON.parse(JSON.stringify(found));
    }
    return JSON.parse(JSON.stringify(exports.PRESET_SMALL_NEURAL_SYSTEM));
}
/**
 ...
 */
function applyImaging100xDemo(scenario) {
    return {
        ...scenario,
