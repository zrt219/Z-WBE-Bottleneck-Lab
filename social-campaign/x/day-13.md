...
- **Media**: `ad_05.png, 06_colab_gpu_extensions_and_terminal.png`
- **Media Order**: 1. ad_05.png -> 2. 06_colab_gpu_extensions_and_terminal.png
...
- **Media**: `social_card_data_analytics.png, badge_data_analytics.png`
- **Media Order**: 1. social_card_data_analytics.png -> 2. badge_data_analytics.png
...
- **Media**: `03_colab_cuml_linear_regression.png, cpu_vs_gpu_speedup.png`
- **Media Order**: 1. 03_colab_cuml_linear_regression.png -> 2. cpu_vs_gpu_speedup.png
...
- **Media**: `banner-dark.png, ad_08.png`
- **Media Order**: 1. banner-dark.png -> 2. ad_08.png
