...
- **Media**: `ad_08.png, 01_colab_notebook_overview.png`
- **Media Order**: 1. ad_08.png -> 2. 01_colab_notebook_overview.png
...
- **Media**: `07_github_notebook_code_provenance.png, banner-dark.png`
- **Media Order**: 1. 07_github_notebook_code_provenance.png -> 2. banner-dark.png
...
- **Media**: `02_colab_t4_gpu_runtime_dialog.png, 05_colab_nvidia_smi_ensemble_eval.png`
- **Media Order**: 1. 02_colab_t4_gpu_runtime_dialog.png -> 2. 05_colab_nvidia_smi_ensemble_eval.png
...
### Media Attachments
**Format**: Multi-Image Carousel (2 images)
1. `public/colab-evidence/02_colab_t4_gpu_runtime_dialog.png`
...
- **Media**: `ad_03.png, banner-light.png`
- **Media Order**: 1. ad_03.png -> 2. banner-light.png
...
2. `public/images/banner-light.png`
