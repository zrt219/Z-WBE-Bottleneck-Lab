# Z-WBE 21-Day Campaign: LinkedIn - Day 04
...
- **Buffer Post ID**: `buffer_li_d04_p1`
...
```markdown
Why Amdahl's Law is the most brutal rule in systems engineering.
...
- **Buffer Post ID**: `buffer_li_d04_p2`
- **Buffer Status**: `SCHEDULED`
- **Platform**: LinkedIn
- **Campaign Day**: Day 04
- **Content Pillar**: Pillar B: Systems Engineering
...
```markdown
How does Z-WBE determine which constraint is 'Dominant'?
...
- **Buffer Post ID**: `buffer_li_d04_p3`
- **Buffer Status**: `SCHEDULED`
- **Platform**: LinkedIn
- **Campaign Day**: Day 04
...
### Media Attachments
**Format**: Video (MP4)
- `public/recordings/hero_bottleneck_shift.mp4`

### Post Copy

```markdown
Video capture: The moment the bottleneck jumps from Acquisition to Memory Bandwidth.
...
- **Buffer Post ID**: `buffer_li_d04_p4`
- **Buffer Status**: `SCHEDULED`
- **Platform**: LinkedIn
- **Campaign Day**: Day 04
...
- **Buffer Post ID**: `buffer_li_d04_p5`
- **Buffer Status**: `SCHEDULED`
- **Platform**: LinkedIn
- **Campaign Day**: Day 04
...
```markdown
Day 4 Build Log: Writing unit tests for bottleneck phase transitions.
