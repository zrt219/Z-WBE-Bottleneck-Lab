# Social Media Launch Kit & Official Form Submission

Use this guide to post your submission to **LinkedIn** and **X (Twitter)**, and complete the official contest entry form.

---

## 1. LinkedIn Launch Post

Attach one of the approved badges/cards:
- 📥 [Speed Up Data Analytics on GPUs Social Card](https://services.google.com/fh/files/misc/nvidiagtcberlinspeedupdataanalyticsongpus.png)
- 📥 [NIM on GKE Social Card](https://services.google.com/fh/files/misc/nvidiagtcberlindeployfastergenerativeaimodelswithnvidianimongke.png)

### Post Copy:
```markdown
I am thrilled to present Z-WBE Bottleneck Lab, built for the Google Cloud × NVIDIA GTC Berlin 2026 Golden Ticket Challenge!

The debate surrounding Whole Brain Emulation is often trapped in isolated silos: microscopists assume compute is trivial, while computer architects assume connectome imaging is solved. 
...
📊 100,000-Scenario Parameter Sweep: Accelerated using NVIDIA RAPIDS (cudf.pandas) in Google Cloud Colab Enterprise.
...
## 3. Official Form Submission Answers

Submit before **September 10, 11:59 PM PST** at: **[forms.gle/pVjTK6H8Vx4WtFWs5](https://forms.gle/pVjTK6H8Vx4WtFWs5)**

* **Project Title**: `Z-WBE Bottleneck Lab`
* **Project Tagline**: `Change the assumptions. See what breaks first.`
